...
# 保存所有张量
save_tensor_bin(Q, "/cuda_code/course9/tmp/Q.bin")
print(Q)
save_tensor_bin(K, "/cuda_code/course9/tmp/K.bin")
save_tensor_bin(V, "/cuda_code/course9/tmp/V.bin")
save_tensor_bin(O, "/cuda_code/course9/tmp/O.bin")
